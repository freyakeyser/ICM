...
```{r tunes,include=F,echo=F,warning=F,message=F}
  ...
  # Danielle this should run the code for Stock #2
  i <- Stocks[2] 
  #for(i in Stocks)
  #{
    years <- years.tmp[[i]]
...
STOP HERE DANIELLE, THE REST OF THIS STUFF IS JUST TAKING MODEL OUTPUT AND PLOTING OR MAKING SECONDARY PRODUCTS FROM THE RESULTS.
