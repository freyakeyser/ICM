...
source("D:/Github/ICM/Scripts/functions/tuning_sim.R")

# Choose 5 ICES stocks that we have the necessary data for
#ASR <- read_xlsx("../Data/ASR_2018.xlsx", sheet = "ICES")
ASR1 <- read.csv("D:/Github/ICM/Data/ICM_data_NE_atlantic_stocks.csv")
ASR <- read.csv("D:/Github/ICM/Data/ICM_data_NW_atlantic_stocks.csv")
...
save(years.tmp,pnm.tmp,waa.tmp,ages.tmp,rem.tmp,mx.tmp,NE.tmp,vpa.tmp,mr.tmp,am.tmp,Stocks,ASR_stocks,ASR_long,file = "D:/Github/ICM/Results/model_inputs.Rdata")
...
ggplot(quants) + geom_line(aes(x=years,y=med))
...
# saveRDS(object = back.res,file = "D:/Github/ICM/Results/backwards_sim_results.Rds")
# saveRDS(object = back.ts,file = "D:/Github/ICM/Results/backwards_sim_ts_summaries.Rds")
# saveRDS(object = back.ts.quants,file = "D:/Github/ICM/Results/backwards_sim_ts_quantiles_summaries.Rds")
```
