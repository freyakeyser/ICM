...
for (i in unique(ASR_long$Stock)) {
  ...
  if(!dir.exists(paste0("../Figures/", i))) dir.create(paste0("../Figures/", i))
  
  png(filename=paste0("../Figures/", i, "/data_summary_", i, ".png"), height=4, width=12, res=400, units="in")
  print(p1)
  dev.off()
}
...
for(i in Stocks){
  ...
  png(filename=paste0("../Figures/", i, "/runs_vs_vpa_", i, ".png"), height=4, width=6, res=400, units="in")
  print(p2)
  dev.off()
  png(filename=paste0("../Figures/", i, "/runs_vs_vpa_ribbon_", i, ".png"), height=4, width=6, res=400, units="in")
  print(p3)
  dev.off()
  png(filename=paste0("../Figures/", i, "/growth_", i, ".png"), height=4, width=6, res=400, units="in")
  print(p4)
  dev.off()
}
```
