...
\newpage
```{r dub-vs-sd, echo=F, fig.cap="The number of stocks which doubled in size by a given year with no fishing mortality  The dashed line represents the 77 stocks in the analysis."}
