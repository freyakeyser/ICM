...
save_plot(paste0(loc,"/Figures/tuned/No_age_correction/Lambda_boxplot_other_species_",what.2.tune,".png"),new.lam.plt.others,base_width = 19,base_height = 15)
...
dd.nf.overall.plt <-ggplot(no.stock.gam.nf.dat , aes(x=prop.abund,y=exp(fit))) + 
                                ...
                                xlab("") + 
                                scale_y_log10(name = "Lambda(FM=0)",breaks = log_breaks(n=10),limits=c(0.2,12)) +
...
dd.stocks.nf.plt <- ggplot(pred.dd.stock.gam.ss.nf,aes(x=prop.abund,y=lam.no.fish,group=Stock.short,color=G.Species,shape=G.Species)) + 
                                ...
                                scale_y_log10(name = "Lambda (FM=0)",breaks = log_breaks(n=10)) +
