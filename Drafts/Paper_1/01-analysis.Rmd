...
```{r tunes,include=F,echo=F,warning=F,message=F}
  ...
  saveRDS(for.tune.summary,paste0(loc,"/Results/forwards_fully_tuned_summary_",what.2.tune,".Rds"))
  saveRDS(for.tune.all.res,paste0(loc,"/Results/forwards_fully_tuned_all_res_",what.2.tune,".Rds"))
  # 
}# end if load results
...
if(load.results==F)
{
  ...
  save(dub.time.summary,pop.dam,res.year.final,res.cohort.final,for.tunes,dub.time,for.tune.all,res.lambda.final,meta,meta.sub,
       file=paste0(loc,"/Results/all_cleaned_forward_tune_summaries_",what.2.tune,".Rdata"))
  
  write.csv(meta.sub, paste0(loc,"/Data/metadata.csv"))
} # end if load results
```
...
load(file=paste0(loc,"/Results/all_cleaned_forward_tune_summaries_",what.2.tune,".Rdata"))
pop.dam <- data.frame(pop.dam)
...
save_plot(paste0(loc,"/Figures/tuned/lambda_no_fishing_6_",what.2.tune,".png"),lambda.plt,base_width = 12,base_height = 10)
...
save_plot(paste0(loc,"/Figures/tuned/lambda_with_fishing_6_",what.2.tune,".png"),lambda.plt.fish,base_width = 12,base_height = 10)
...
save_plot(paste0(loc,"/Figures/tuned/Doubling_time_heatmap_by_sp6_",what.2.tune,".png"),dub.heatmap.sp6,base_width = 20,base_height = 17)
...
save_plot(paste0(loc,"/Figures/tuned/GL_boxplot_no_fish_6_species_",what.2.tune,".png"),gen.boxplt,base_width = 12,base_height = 10)
...
save_plot(paste0(loc,"/Figures/tuned/R0_boxplot_no_fish_6_species_",what.2.tune,".png"),r0.boxplt,base_width = 12,base_height = 10)
...
save_plot(paste0(loc,"/Figures/tuned/Doubling_time_heatmap_by_order_",what.2.tune,".png"),dub.heatmap,base_width = 20,base_height = 20)
...
#lambda.ts.plt
save_plot(paste0(loc,"/Figures/tuned/lambda_timeseries_6_",what.2.tune,".png"),lambda.ts.plt,base_width = 12,base_height = 10)
...
lambda.dec.plt <- ggplot(res.lambda.final.6,aes(y=med.lam,x=as.factor(decade))) +
                            ...
                            geom_hline(yintercept = 1,linetype='dashed') +
                            facet_wrap(~G.Species,scales='free_y') 
save_plot(paste0(loc,"/Figures/tuned/lambda_by_decade_6_",what.2.tune,".png"),lambda.dec.plt,base_width = 12,base_height = 12)
...
save_plot(paste0(loc,"/Figures/tuned/gen_heatmap_",what.2.tune,".png"),gen.heatmap,base_width = 20,base_height = 17)
...
save_plot(paste0(loc,"/Figures/tuned/r0_heatmap_",what.2.tune,".png"),r0.heatmap,base_width = 20,base_height = 17)
